...
namespace BubbasEngine.Engine.Physics.Common
{
    ...
    public static class WorldSerializer
    {
        ...
        public static void Serialize(PhysicsWorld world, string filename)
        {
        ...
        /// </summary>
        /// <param name="filename"></param>
        public static PhysicsWorld Deserialize(string filename)
        {
    ...
    internal static class WorldXmlSerializer
    {
        ...
        internal static void Serialize(PhysicsWorld world, Stream stream)
        {
    ...
    {
        internal static PhysicsWorld Deserialize(Stream stream)
        {
            PhysicsWorld world = new PhysicsWorld(Vector2.Zero);
            Deserialize(world, stream);
            return world;
        }

        private static void Deserialize(PhysicsWorld world, Stream stream)
        {
            List<Body> bodies = new List<Body>();
            List<Fixture> fixtures = new List<Fixture>();
