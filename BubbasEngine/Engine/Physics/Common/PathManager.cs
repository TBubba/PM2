...
namespace BubbasEngine.Engine.Physics.Common
{
    /// <summary>
    ...
    public static class PathManager
    {
        ...
        /// <returns></returns>
        public static List<Body> EvenlyDistributeShapesAlongPath(PhysicsWorld world, Path path, IEnumerable<Shape> shapes, BodyType type, int copies, object userData = null)
        {
        ...
        /// <returns></returns>
        public static List<Body> EvenlyDistributeShapesAlongPath(PhysicsWorld world, Path path, Shape shape, BodyType type,
        ...
        public static List<Body> EvenlyDistributeShapesAlongPath(PhysicsWorld world, Path path, Shape shape, BodyType type, int copies)
        {
