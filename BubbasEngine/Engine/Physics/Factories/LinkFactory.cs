...
namespace BubbasEngine.Engine.Physics.Factories
{
    public static class LinkFactory
    {
        ...
        /// <returns></returns>
        public static Path CreateChain(PhysicsWorld world, Vector2 start, Vector2 end, float linkWidth, float linkHeight, int numberOfLinks, float linkDensity, bool attachRopeJoint)
        {
