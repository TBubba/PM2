...
using BubbasEngine.Engine.Physics.Common.PhysicsLogic;
using BubbasEngine.Engine.Physics.Controllers;
using BubbasEngine.Engine.Physics.Dynamics.Contacts;
using BubbasEngine.Engine.Physics.Dynamics.Joints;


namespace BubbasEngine.Engine.Physics.Dynamics
{
    /// <summary>
    /// The body type.
    /// </summary>
    ...
    public class Body : IDisposable
    {
        ...
        /// <param name="world"></param>
        /// <returns></returns>
        public Body DeepClone(PhysicsWorld world = null)
        {
